...
function Header(){
  ...
  const overlay = (location.pathname === devHome && window.location.pathname === 'localhost') ||
    (location.pathname === prodHome && window.location.pathname !== 'localhost')
  ...
  const headerClass = 'header' + ((location.pathname !== devHome && window.location.pathname === 'localhost') || (location.pathname !== prodHome && window.location.pathname !== 'localhost') ? ' small' : '')
